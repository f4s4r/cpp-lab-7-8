...
MaintenanceRecord::MaintenanceRecord() :
    services_(nullptr), num_serv_(0), cmnt_to_lst_serv_("")
{}
MaintenanceRecord::MaintenanceRecord(int num_serv, std::string comment) :
    services_(nullptr), num_serv_(num_serv), cmnt_to_lst_serv_(std::move(comment))
{}
MaintenanceRecord::~MaintenanceRecord()
{
    services_ = nullptr;
...
//methods
void MaintenanceRecord::demo(size_t id_) const
{
